...
export const ADMIN_PAGE_CATALOG: AdminPageEntry[] = [
  ...
  {
    id: 'nav-event-types',
    routeName: 'eventTypes.index',
    labelKey: 'Renginių tipai',
    icon: CalendarIcon,
    category: 'navigation',
    keywords: ['event types', 'renginiu tipai', 'kategorijos', 'kalendorius'],
    can: c => !!c.index?.eventType || !!c.index?.calendar,
  },
  {
    id: 'nav-tags',
    ...
    icon: TagIcon,
    category: 'navigation',
    keywords: ['tags', 'zymos', 'temos', 'topics'],
    can: c => !!c.index?.tag,
  },
  {
    id: 'nav-news',
