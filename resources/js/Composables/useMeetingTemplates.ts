...
export function useMeetingTemplates(providedRecentMeetings?: RecentMeeting[]) {
  ...
  const standardTemplates: MeetingTemplate[] = [
    {
      id: 'standard-board',
      name: $t('Valdybos posėdis'),
      description: $t('Standartinis valdybos posėdžio šablonas'),
      type: 'standard',
      institutionTypes: ['valdyba', 'taryba'],
      agendaItems: [
    ...
    },
    {
      ...
      name: $t('Komisijos posėdis'),
      description: $t('Standartinis komisijos posėdžio šablonas'),
      type: 'standard',
      institutionTypes: ['komisija'],
      agendaItems: [
        $t('Veiklų ataskaitos pristatymas'),
        $t('Naujų projektų aptarimas'),
    ...
    {
      id: 'standard-general',
      name: $t('Bendrasis posėdis'),
      description: $t('Universalus posėdžio šablonas'),
      type: 'standard',
      agendaItems: [
    ...
    },
    {
      ...
      name: $t('Planavimo posėdis'),
      description: $t('Strateginio planavimo posėdžio šablonas'),
      type: 'standard',
      agendaItems: [
        $t('Einamos situacijos analizė'),
        $t('Tikslų ir prioritetų nustatymas'),
        $t('Veiklų planavimas'),
        $t('Išteklių paskirstymas'),
        $t('Laiko grafiko sudarymas')
      ],
    ...
    {
      id: 'standard-review',
      name: $t('Veiklų apžvalgos posėdis'),
      description: $t('Veiklų įvertinimo ir ataskaitos posėdžio šablonas'),
      type: 'standard',
      agendaItems: [
        $t('Ankstesnių veiklų ataskaita'),
        $t('Rezultatų pristatymas'),
        $t('Problemų identifikavimas'),
        $t('Sprendimų paieška'),
        $t('Tolimesnių veiksmų planavimas')
      ],
      suggestedDuration: 90,
      isDefault: false
    }
