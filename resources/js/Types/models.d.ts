...
declare global {
  export namespace models {
    ...
    export interface PlanningActivity {
      ...
      // counts
      // exists
      planning_process_exists: boolean
    }
    ...
    export interface PlanningMonitoringEntry {
      // columns
      id: string
      planning_process_id: string
      quarter: number
    ...
    export interface PlanningProcess {
      ...
      expectations_submitted_at?: string | null
      meeting_1_notes?: string | null
      ...
      selected_problem_exists: boolean
      tip_approved_by_user_exists: boolean
      mvp_approved_by_user_exists: boolean
      activities_exists: boolean
      monitoring_entries_exists: boolean
      media_exists: boolean
    }
    ...
    export interface PlanningStageDeadline {
      // columns
      id: string
      academic_year_start: number
      stage: number
