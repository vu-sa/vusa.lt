        ...
        <div class="prose prose-sm col-span-3 px-12 dark:prose-invert">
          ...
          <template v-if="$page.props.app.locale === 'lt'">
            <p>
              ...
              naujai prisijungusius (-ias) primo kurso studentus (-es). Tik
              įstojus į Universitetą, studentams (-ėms) iškyla daug klausimų, į
              kuriuos atsakyti tegali studijų pradžią jau patyrę studentai
              (-ės).
            </p>

            <p>
              Vilniaus universiteto Studentų atstovybės (VU SA) vykdoma
              kuratorių programa pradėjo veikti dar 2000 metais ir nuo tų laikų
              sėkmingai prisideda prie bendros VU studentų (-čių) integracijos į
              Universitetą proceso. Specialius mokymus išklausę kuratoriai (-ės)
              supažindina Universiteto pirmakursius (-es) su studijų tvarka ir
              VU tradicijomis, padeda spręsti akademinius bei socialinius
              klausimus, suprasti Universiteto bei miesto infrastruktūrą.
            </p>
            ...
            <p>
              Šiais metais visame Universitete kuratorių programoje veikė
              daugiau nei 300 studentų (-čių), kurie (-ios) padėjo integruotis
              daugiau nei 4000 pirmakursių bei prisidėjo ir prie platesnių
              integracijos veiklų įgyvendinimo: padalinio pirmakursių stovyklų ,
              VU SA Integracijos festivalio „Ad Astra“ , pasiruošimo ir studentų
              (-čių) koordinavimo šventinėje VU rugsėjo 1-sios eisenoje,
              integracijos savaitės padaliniuose organizavimo. Taip pat metų
              eigoje kuratoriai (-ės) prisideda prie įvairiausių VU SA vykdomų
              projektų ir iniciatyvų: renginio VUnity, Mentorių programos
              atnaujinimo, VU SA Studentiško gyvenimo vadovo optimizavimo.
            </p>

            <p>
              Ar esi žmogus, kuriam patinka dalintis savo patirtimi bei žiniomis
              ir norėtum nešti teigiamą poveikį pirmakursių gyvenimui?
            </p>
            ...
            <p>
              ...
              <strong
                >2023 m. Kuratorių atrankos prasideda tavo padalinyje!</strong
              >
            </p>
          </template>
          <template v-else-if="$page.props.app.locale === 'en'">
            <p>
              Every year, the Vilnius University (VU) community starts the
              academic year by welcoming the new first-year students. Once they
              have joined the University, students have many questions that the
              mentors are always ready to answer.
            </p>
            ...
            <p>
              ...
              contributing to the overall process of integration of VU students
              into the University since then. The mentors, who have received
              special training, introduce the University's first-year students
              to the study procedures and traditions of VU, help them to deal
              with academic and social issues, and help them to understand the
              infrastructure of the University and the city.
            </p>
            ...
            <p>
              ...
              mentoring of first-year international students. Also, seeing the
              need for the integration of second cycle students, mentors for
              first-year Master’s (MA) students were introduced.
            </p>
            ...
            <p>
              ...
              programme across the University, helping to integrate more than
              4,000 first-year students and also contributing to the
              implementation of broader integration activities: organising
              first-year camps, organising the VU SR Integration Festival "Ad
              Astra", preparing and coordinating the students in the celebratory
              VU community procession on 1 September, and organising the
              Integration Week in the units. In the course of the year, the
              mentors also contribute to a wide range of VU SR projects and
              initiatives: the organisation of the VUnity event, the renewal of
              the Mentor’s Programme, the optimisation of the VU SR Student Life
              Guidebook.
            </p>

            <p>
              Are you a person who enjoys sharing your experience and knowledge
              and would like to make a positive impact on the lives of
              first-year students?
            </p>
