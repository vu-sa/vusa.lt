...
Naujienų archyvas
    ...
    <HomeCard :has-mini-content="false" :has-below-card="true">
      ...
      <template #below-card>
        ...
        <NIcon class="mr-2" size="20">
          <Clock20Regular />
        </NIcon>{{ formatStaticTime(new Date(item.publish_time), { year: "numeric", month: "long", day: "numeric" },
  ...
  <NPagination style="overflow-x: auto" class="mb-2 mt-12" :item-count="props.news.total" :page="props.news.current_page"
    :page-size="15" :show-quick-jumper="true" @update:page="handlePageChange" />
</template>
