      ...
      <section id="apie-vu-sa">
        ...
        <div class="bg-white py-6 px-12 rounded-lg max-w-[80ch] prose mx-auto my-4">
          <p>
            ...
            studentams Universitete ir už jo ribų, puoselėjanti universitetinę kultūrą ir
            kurianti palankiausias sąlygas studento saviraiškai.
          </p>
          ...
          <p>
            ...
            padalinius ir PKP, bei VU Studentų savivaldos Alumni draugija. Šiuo metu VU SA
            vienija apie 1 000 narių.
          </p>

          <strong>VU SA:</strong>
          <ul>
            <li>
              atstovauja studentams – gina studentų teises Universiteto valdymo organuose
              ir nacionaliniu lygmeniu;
            </li>
            <li>
              prisideda prie studijų proceso tobulinimo Universitete, yra visų svarbiausių
              VU valdymo institucijų dalis;
            </li>
            <li>
      ...
      <section id="strategija">
        ...
        <div class="bg-white py-6 px-12 rounded-lg max-w-[80ch] prose mx-auto my-4">
          ...
          <p>
            ...
            studentams bei puoselėjant universitetinę kultūrą kurti palankiausias sąlygas
      ...
      <section id="valdymo-schema">
        ...
        <div class="bg-white py-6 px-12 rounded-lg max-w-[80ch] prose mx-auto my-4">
          <p>
            ...
            kompetenciją priima sprendimus jiems paskirtose srityse arba užtikrina kituose
            VU SA valdymo organuose priimtų nutarimų vykdymą.
          </p>
          <p>
      ...
      <section id="parlamentas">
        ...
        <div class="bg-white py-6 px-12 rounded-lg max-w-[80ch] prose mx-auto my-4">
          ...
          <p>
            ...
            viceprezidentas, atstovavimo funkciją vykdančių VU SA padalinių pirmininkai ir
            po du atstovus iš kiekvieno padalinio. Parlamento darbą organizuoja
            pirmininkas.
          </p>
          <p>
            ...
            <NCollapse accordion>
              <NCollapseItem>
                ...
                <p>
                  ...
                  rezoliuciją dėl užsienio studentų integracijos Universitete. Suvokdamas
                  ...
                  informaciją užsienio studentams (-ėms). Taip pat rašte akcentuojama
          ...
          <ul>
            ...
            <li>
              ...
              puslapyje publikuoti straipsniai, informuojantys apie tai, kas buvo aptarta
              ir patvirtinta posėdžių metu;
            </li>
            <li>
            ...
            <li>
              Du kartus vykdyti individualūs pokalbiai tarp VU SA Parlamento pirmininkų ir
              VU SA padalinių parlamentarų, skirti padalinių problemų ir nuomonės
        ...
        <div class="bg-white py-6 px-12 rounded-lg max-w-[80ch] prose mx-auto my-4">
          ...
          <ul>
            ...
            <li>
              ...
              padaliniuose yra) bei VU SA marketingo koordinatoriaus surinkti savanoriai;
            </li>
            <li>
