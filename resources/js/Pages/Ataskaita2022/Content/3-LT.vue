  ...
  <Planas>
    ...
    <NTimeline class="mt-4">
      <NTimelineItem
        ...
        content=" Vieningo su VU 60 kreditų atlaisvinimo (vidinio mobilumo) studijų programose modelio ir įgyvendinimo plano (diegimo nuostatų) parengimas. Išsiaiškinti VU ir VU KAP situaciją lanksčių
 studijų klausimu."
      ></NTimelineItem>
      <NTimelineItem
        type="success"
...
nariams."
    ...
    <!-- <div class="col-span-4 mb-12">
      <Link
        ...
        :href="
          route('ataskaita2022', { lang: $page.props.app.locale, permalink: 'studijos' })
        "
