<template>
  <footer
    class="grid items-center justify-items-center gap-2 border-t border-gray-100 bg-stone-50 p-8 text-sm text-gray-500 shadow-md dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 md:grid-cols-2 lg:px-32"
  >
    <div>
      <p>{{ $t("Vilniaus universiteto Studentų atstovybė") }}</p>
      <p>{{ $t("Įmonės kodas") }}: 193077294</p>
      <p>{{ $t("Juridinis asmuo nėra PVM mokėtojas") }}</p>
    </div>
    <div>
      <div
