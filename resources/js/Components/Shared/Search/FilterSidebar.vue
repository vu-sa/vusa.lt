<template>
  <div class="space-y-4">
    <!-- Mobile Filter Button: xl matches BaseSearchInterface's grid breakpoint, so the
         expanded desktop filters never render inline above results between lg and xl -->
                ...
                <div class="flex items-center justify-between">
                  ...
                  >
                    ...
                    <template v-if="activeFilterCount > 0">
                      {{ $t('search.clear_filters_count', { count: String(activeFilterCount) }) }}
                    </template>
                    <template v-else>
