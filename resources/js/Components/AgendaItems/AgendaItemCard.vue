<template>
  <Card class="agenda-item-card group hover:shadow-md transition-all duration-200 cursor-pointer">
    <CardContent class="p-4">
      <div class="flex items-start gap-3">
        <!-- Drag Handle -->
        <div class="drag-handle flex-shrink-0 cursor-move p-2 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">
          <GripVertical class="h-4 w-4" />
        </div>
        
        <!-- Item Number -->
        <div class="flex-shrink-0 w-8 h-8 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-sm font-medium text-zinc-600 dark:text-zinc-400">
          {{ order }}
        </div>
        ...
        <div class="flex-1 min-w-0 space-y-3">
          ...
          <div class="flex flex-wrap items-center gap-2">
            ...
            <StatusBadge 
              v-if="item.student_vote || showVoteOptions" 
            ...
            <StatusBadge 
              v-if="item.student_benefit || showVoteOptions" 
            ...
            >
              <component 
                :is="item.description ? FileText : FilePlus" 
                class="h-3 w-3 mr-1" 
              />
          ...
          <Collapsible v-if="showVoteOptions" v-model:open="showDetailed">
