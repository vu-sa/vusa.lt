    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar text-sm flex-column" data-widget="treeview" role="menu">
                ...
                <li class="nav-item {{ strpos(request()->path(), 'admin/pagrindinis') !== false ? 'active' : '' }}">
                ...
                @can('handle', App\Models\Contact::class)
                    <li
                        class="nav-item has-treeview {{ strpos(request()->path(), 'admin/kontaktai/') !== false ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/aprasymas') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Centrinis biuras') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Centrinis biuras EN') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Parlamentas') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Parlamento darbo grupės') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Padaliniai') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Taryba') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Revizija') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Institucinio stiprinimo fondas') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Studentų atstovai LT') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Studentų atstovai EN') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                            {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Programos, klubai ir projektai') !== false ? 'active' : '' }}">
                        ...
                        @can('handlePadaliniai', App\Models\Contact::class)
                            <li
                                class="nav-item
                    {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/aprasymas-padalinys') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                    {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/padalinio-biuras') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                    {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/padalinio-biuras-en') !== false ? 'active' : '' }}">
                    ...
                    {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/{name}/Centrinis biuras EN') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                    {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/padalinio-kuratoriai') !== false ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item
                    {{ strpos(request()->path() . '/' . $name, 'admin/kontaktai/padalinio-kuratoriai-en') !== false ? 'active' : '' }}">
                ...
                @can('handle', App\Models\Navigation::class)
                    <li
                        class="nav-item has-treeview {{ strpos(request()->path(), 'admin/navigacija') !== false ? 'active' : '' }}">
                        <a href="#" class="nav-link"> <i class="nav-icon fas fa-bars"></i>
                            <p>Navigacija <i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li
                                class="nav-item {{ strpos(request()->path(), 'admin/navigacijaLT') !== false ? 'active' : '' }}">
                                <a href="/admin/navigacijaLT" class="nav-link"><i class="far fa-circle fa-sm"></i>
                                    <p>Navigacija LT</p>
                                </a>
                            </li>
                            <li class="nav-item {{ request()->path() == 'admin/navigacijaEN' ? 'active' : '' }}">
                ...
                @can('handle', App\Models\Page::class)
                    <li
                        class="nav-item has-treeview {{ strpos(request()->path(), 'admin/naujienos') !== false ? 'active' : '' }}">
                        <a href="#" class="nav-link"> <i class="nav-icon fas fa-newspaper"></i>
                            <p>Naujienos<i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li
                                class="nav-item {{ strpos(request()->path(), 'admin/naujienosLT') !== false ? 'active' : '' }}">
                            ...
                            @can('handle', App\Models\Page::class)
                                <li
                                    class="nav-item {{ strpos(request()->path(), 'admin/naujienosEN') !== false ? 'active' : '' }}">
                ...
                @can('handle', App\Models\Page::class)
                    ...
                    {{ strpos(request()->path(), 'admin/puslapiai') !== false ? 'active' : '' }}">
                        <a href="#" class="nav-link"> <i class="nav-icon far fa-newspaper"></i>
                            <p>Puslapiai<i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li
                                class="nav-item {{ strpos(request()->path(), 'admin/puslapiaiLT') !== false ? 'active' : '' }}">
                            ...
                            @can('handle', App\Models\Page::class)
                                <li
                                    class="nav-item {{ strpos(request()->path(), 'admin/puslapiaiEN') !== false ? 'active' : '' }}">
                ...
                @can('handle', App\Models\Agenda::class)
                    <li class="nav-item {{ strpos(request()->path(), 'admin/agenda') !== false ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ strpos(request()->path(), 'admin/calendar') !== false ? 'active' : '' }}">
                ...
                @can('handleUsers', App\Models\User::class)
                    <li
                        class="nav-item has-treeview {{ strpos(request()->path(), 'admin/vartotojai') !== false || strpos(request()->path(), 'admin/grupes') !== false ? 'active' : '' }}">
                        <a href="#" class="nav-link"><i class="nav-icon fas fa-user"></i>
                            <p>Vartotojų, grupių valdymas<i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li
                                class="nav-item {{ strpos(request()->path(), 'admin/vartotojai') !== false ? 'active' : '' }}">
                                <a href="/admin/vartotojai" class="nav-link"><i class="fas fa-user"></i>
                                    <p>Vartotojų
                                        valdymas</p>
                                </a>
                            </li>
                            <li class="nav-item {{ strpos(request()->path(), 'admin/grupes') !== false ? 'active' : '' }}">
                ...
                @can('handleFiles', App\Models\User::class)
                    <li class="nav-item {{ strpos(request()->path(), 'admin/failai') !== false ? 'active' : '' }}">
                ...
                @can('handle', App\Models\Padalinys::class)
                    <li class="nav-item {{ strpos(request()->path(), 'admin/padaliniai') !== false ? 'active' : '' }}">
                ...
                @can('handle', App\Models\Banner::class)
                    <li class="nav-item {{ strpos(request()->path(), 'admin/banner') !== false ? 'active' : '' }}">
                ...
                @can('handle', App\Models\Saziningai::class)
                    <li
                        class="nav-item has-treeview {{ strpos(request()->path(), 'admin/exam') !== false ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li
                                class="nav-item {{ strpos(request()->path(), 'admin/exam') !== false ? 'active' : '' }}">
                                <a href="/admin/exam" class="nav-link"><i class="fa fa-book"></i>
                                    <p>Atsiskaitymų informacija</p>
                                </a>
                            </li>
                            <li
                                class="nav-item {{ strpos(request()->path(), 'admin/examPeople') !== false ? 'active' : '' }}">
                                <a href="/admin/examPeople" class="nav-link"><i
                ...
                @endcan
                <li class="nav-item {{ strpos(request()->path(), 'admin/atnaujinimai') !== false ? 'active' : '' }}">
