            ...
            <div class="row ">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::password('password', array('class'=>'form-control','placeholder'=>'Jūsų slaptaždodis')) }}
                        {{ Form::password('password_repeat', array('class'=>'form-control','placeholder'=>'Pakartokite slaptažodį')) }}
                    </div>

                    <div class="form-group">
                        {{ Form::label('gid', 'Naudotojo grupė *') }}
                        {{ Form::select('gid', $userGroups, '1', array('class'=>'form-control'))}}
                    </div>
