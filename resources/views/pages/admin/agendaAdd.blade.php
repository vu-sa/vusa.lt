...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Sukurti naują darbotvarkės įrašą
                <br/>
                <small style="color: red">* - reikalingi laukai</small>
            </h1>
            <ol class="breadcrumb">
                {!! $currentRoute == 'admin/kalendorius/prideti' ? '<li><a><i class="fas fa-tachometer-alt"></i> Home</a></li> <li class="active">Pridėti darbotvarkės įrašą</li>': '' !!}
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <br/>
                        {{-- {{ Form::selectYear('year', date('Y'), date('Y')+2) }}:
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::textarea('description', '', array('class'=>'form-control edit')) }}
                    </div>
