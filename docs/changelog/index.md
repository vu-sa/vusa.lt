...
- ✨ **Procesų schema redaguojama viso ekrano režimu** — schemos tipą galima pasirinkti neišeinant iš vaizdinio redaktoriaus, o raudoni, geltoni, kraštinių ir rodyklių elementai dabar dera prie naujo svetainės stiliaus
- ✨ **Nuotraukų tinklelis ir galerija redaguojami tiesiogiai** — viso ekrano redaktoriuje galima pridėti, pakeisti ar pašalinti kelias nuotraukas, pakoreguoti alternatyvųjį tekstą bei pasirinkti vaizdo fokusą neišeinant iš puslapio vaizdo
- ✨ **Kortelės ir statistikos redaguojamos tiesiogiai** — kortelės antraštė ryškesnė, aprašymas turi aiškią vietą pradėti rašyti ir pasirenkamus vertikalius tarpus; nauja statistika iš karto gauna pirmą rodiklį, kurio skaičius, pavadinimas ir pliuso ženklas keičiami neišeinant iš pilno ekrano redaktoriaus
- ✨ **Nebereikia atskiro tarpo bloko** — kiekvieno turinio bloko vertikalūs tarpai parenkami jo nustatymuose, todėl „Tarpas“ pašalintas iš turinio redaktoriaus
...
- ✨ **Atnaujintas renginių sąrašas ir greita „Typesense“ paieška** — renginių sąrašas perkeltas į naują viešos svetainės stilių su integruota antraštės navigacijos juosta, 3 stulpelių kortelių tinkleliu, būsimų ir praėjusių renginių skirtukais, metų pasirinkimo filtru, greita momentine paieška pagal pavadinimą, aprašymą ir vietą bei patogiais iškylančiais filtrų meniu pagal kategoriją, padalinį ar nuotolinį formatą
- ✨ **Aiškesnis renginių sąrašo naršymas** — trumpi „Būsimi“, „Praėję“ ir „Visi“ skirtukai, metų filtras tarp kitų filtrų bei atskiras rikiavimas pagal aktualumą arba datą leidžia greičiau rasti reikiamus renginius
...
- ✨ **Vėžliukas puslapio įkėlimo indikatoriuje ir tuščiuose sąrašuose** — vietoje įprasto sukamo apskritimo puslapio kampe dabar lėtai žingsniuoja organizacijos talismanas (jis kartu su įkėlimo juosta naudoja VU SA spalvą, kuri prisitaiko prie šviesaus arba tamsaus režimo), o ten, kur dar nėra ką rodyti, sąrašo viduryje ilsisi tas pats vėžliukas
