...
- ✨ **Clearer secondary actions** — filters, cancel buttons and other secondary actions in Mano VU SA now use sentence case; links show a visible outline when reached by keyboard. [Read more](/pagrindai/platforma#mygtukai-ir-klaviatura)
