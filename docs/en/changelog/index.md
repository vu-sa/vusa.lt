...
- 📱 PWA and notification system
- 🔍 Searchable agenda items for administrators
- 🔤 New font — Atkinson Hyperlegible Next
- 🏨 Updated reservation views
- 🔐 Fixed Microsoft authentication
- ✏️ Updated rich content editor
- 🔗 Extended institution relationship system
