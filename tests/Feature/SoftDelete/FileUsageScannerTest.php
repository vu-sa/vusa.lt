...
test('a file used only by a trashed record is not reported safe to delete', function () {
...
test('a file used by a live record is still reported as in use', function () {
...
test('a genuinely unreferenced file is still reported safe to delete', function () {
