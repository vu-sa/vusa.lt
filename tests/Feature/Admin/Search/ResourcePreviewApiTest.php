...
test('any authenticated user can preview a resource', function (): void {
...
test('preview lists upcoming active reservations', function (): void {
    $admin = makeAdminUser($this->tenant);
 ...
 */
test('preview keeps ended active reservations in the active list', function (): void {
    $admin = makeAdminUser($this->tenant);
...
test('preview includes terminal past reservations in previous list', function (): void {
    $admin = makeAdminUser($this->tenant);
