...
describe('auth: simple user', function () {
    ...
    test('can\'t index forms', function () {
        asUser($this->user)->get(route('forms.index'))->assertStatus(403);
    });

    test('can\'t access form create page', function () {
        asUser($this->user)->get(route('forms.create'))->assertStatus(403);
    });
    ...
    test('can\'t access the form edit page', function () {
        ...
        asUser($this->user)->get(route('forms.edit', $form))->assertStatus(403);
    });
    ...
    test('can\'t delete form', function () {
        ...
        asUser($this->user)->delete(route('forms.destroy', $form))->assertStatus(403);
    });
});
