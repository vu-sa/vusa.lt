...
describe('rich content: legitimate editor output survives', function () {
    ...
    test('keeps every node the full preset can produce', function (string $html, string $expected) {
        ...
        'heading h4' => ['<h4 id="sub-point">Sub point</h4>', '<h4 id="sub-point">Sub point</h4>'],
        'heading size/accent class' => ['<h2 id="t" class="rc-h-md rc-h-accent-yellow">T</h2>', 'class="rc-h-md rc-h-accent-yellow"'],
        'paragraph alignment class' => ['<p class="rc-align-center">T</p>', '<p class="rc-align-center">T</p>'],
        'dot tag (filled)' => ['<span class="rc-tag rc-tag-filled rc-tag-yellow">Maskotė</span>', '<span class="rc-tag rc-tag-filled rc-tag-yellow">Maskotė</span>'],
        'dot tag (plain)' => ['<span class="rc-tag rc-tag-plain rc-tag-green">Live</span>', '<span class="rc-tag rc-tag-plain rc-tag-green">Live</span>'],
