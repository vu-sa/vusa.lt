...
Project conventions live in [AGENTS.md](../AGENTS.md). Read it before making changes — it covers DO/DON'T patterns, search architecture, permission system, translatable models, i18n, API conventions, styling, and changelog rules.

Sub-directory `CLAUDE.md` files cover their respective domains:

- [tests/CLAUDE.md](../tests/CLAUDE.md) — backend testing
- [resources/js/CLAUDE.md](../resources/js/CLAUDE.md) — frontend testing
- [resources/js/Components/Tables/CLAUDE.md](../resources/js/Components/Tables/CLAUDE.md) — TanStack tables
- [.storybook/CLAUDE.md](../.storybook/CLAUDE.md) — Storybook
- [app/Http/Controllers/CLAUDE.md](../app/Http/Controllers/CLAUDE.md) — controllers
