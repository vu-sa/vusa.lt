            ...
            News::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'important', 'type' => 'bool', 'facet' => true, 'optional' => true],
            ...
            Calendar::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'tenant_name', 'type' => 'string', 'facet' => true],
                        ['name' => 'tenant_shortname', 'type' => 'string', 'facet' => true, 'optional' => true],
                        ['name' => 'event_type_id', 'type' => 'int32', 'facet' => true, 'optional' => true],
                        ['name' => 'event_type_name', 'type' => 'string', 'facet' => true, 'optional' => true],
                        ['name' => 'tag_names', 'type' => 'string[]', 'facet' => true, 'optional' => true],
                        ['name' => 'location', 'type' => 'string', 'optional' => true, 'infix' => true],
                        ['name' => 'is_all_day', 'type' => 'bool', 'optional' => true],
                        ['name' => 'is_remote', 'type' => 'bool', 'facet' => true, 'optional' => true],
                        ['name' => 'is_international', 'type' => 'bool', 'facet' => true, 'optional' => true],
