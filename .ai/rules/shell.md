...
- The six workspaces are Pradžia, ViSAK, Rezervacijos, Svetainė, Organizacija and Sistema. The workspace picker is the only switcher. Breadcrumbs appear only below section level. Below `md` the bottom bar replaces the top bar.
